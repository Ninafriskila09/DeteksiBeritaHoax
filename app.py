...
def process_file(uploaded_file):
    # Assuming you want to read the uploaded Excel file
    data = pd.read_excel(uploaded_file, engine='openpyxl')
    # Perform further processing on the data as needed
    st.write("File processed successfully!")

def main():
    # Assume 'uploaded_file' is the uploaded Excel file
...
def main():
    ...
    if uploaded_file is not None:
        ...
        st.write("Masukkan Teks Prediksi:")
